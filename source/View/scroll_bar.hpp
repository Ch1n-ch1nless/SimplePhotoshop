...
//     const ps::vec2u MOVE_BUTTON_SIZE = ps::vec2u{16u, 16u};
...
//         std::unique_ptr<psapi::sfm::Sprite> scroll_bar_sprite = {};
//         scroll_bar_sprite->setTexture(background_texture.get());

//         double scroll_ratio = (orientation == Orientation::Horizontal) ? psapi::CanvasSize.y : 
//                                                                          psapi::CanvasSize.x    ;

//         ps::Canvas* canvas = static_cast<ps::AWindow*>(psapi::getRootWindow()->getWindowById(psapi::kCanvasWindowId));



//         return std::make_unique<psapi::sfm::Sprite>(std::move(scroll_bar_sprite), 
//                                                     static_cast<Scrollable*>(canvas),
//                                                     scroll_ratio,
//                                                     );
//     }
