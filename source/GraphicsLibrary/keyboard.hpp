#ifndef GRAPHICS_LIBRARY_KEYBOARD_HPP
#define GRAPHICS_LIBRARY_KEYBOARD_HPP
...
namespace Graphics
{
    ...
    public:
        ...
        static bool IsKeyPressed(Key       the_key);
        static bool IsKeyPressed(ScanCode  the_scan_code);

    };
}

#endif //GRAPHICS_LIBRARY_KEYBOARD_HPP